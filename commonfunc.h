...
int UdpRecvDataAndFromIP(int sockfd, unsigned char* buf, int dataLen, struct sockaddr_in *fromaddr);
void DisconnectSock(int isServe, int sockfd, char *mcastAddr);
